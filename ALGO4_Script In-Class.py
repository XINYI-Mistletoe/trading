...
def main():
    ...
    resp = s.post('http://localhost:9999/v1/leases/1', params = {'from1': 'RGLD', 'quantity1': 15000, 'from2': 'RFIN', 'quantity2': 10000})
    creation_resp = resp.json()
    
    currency = int(10000 * 0.0375)
    volume = 10000 * 1
    
    resp = s.post('http://localhost:9999/v1/leases/2', params = {'from1': 'INDX', 'quantity1': volume, 'from2': 'CAD', 'quantity2': currency})
    creation_resp = resp.json()
